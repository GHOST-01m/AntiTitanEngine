...
enum TEXTURE_LAYOUT
{
	...
	EXTURE_LAYOUT_64KB_UNDEFINED_SWIZZLE = 2,
...
class RenderResource_ResourceDESC
{
...
{
public:
	std::shared_ptr<RenderResource_Factory> mFactory;
	std::shared_ptr<RenderResource_Device> mDevice;
	std::shared_ptr<RenderResource_Fence> mFence;

	std::shared_ptr<RenderResource_ResourceDESC> mDepthStencilDesc;
